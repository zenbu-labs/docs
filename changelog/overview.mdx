...
## Week of June 23 — quiet week

No product changes shipped this week. The previous [`@zenbujs/core` API cleanup](/changelog/overview) (June 19) remains the latest release. Regular updates resume next week.
